...
public class CellDisenoActivity extends ArrayAdapter<Diseno> {
    ...
    public CellDisenoActivity(@NonNull Activity context, List<Diseno> disenos, DatabaseReference databaseReference, EditText edtDiseno, String imgDiseno){
    ...
    public View getView(int pos, View view, ViewGroup parent){
        ...
        btnUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DisenosActivity.disId = diseno.getId_diseno();
            }
        });
...
/*
public class CellDisenoActivity extends AppCompatActivity {
