...
public class DisenosActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listViewCat = (ListView) findViewById(R.id.listCategorias);//-->MODIFICAR
        ...
        btnSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(disId)) {
                    ...
                    Toast.makeText(DisenosActivity.this, "Diseño creado!", Toast.LENGTH_SHORT).show();
                } else {
                    //modificar
                    datareferece.child(disId).child("categoria").setValue(design);
                    Toast.makeText(DisenosActivity.this, "Diseño Modificado!!!", Toast.LENGTH_SHORT).show();
                }
    ...
    protected void onStart() {
        ...
        datareferece.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                CellDisenoActivity disAdapter = new CellDisenoActivity(DisenosActivity.this, disenos, datareferece, editTextDiseno, editTextImg.toString());
                listViewCat.setAdapter(disAdapter);
            }
